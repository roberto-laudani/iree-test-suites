...
pinned by revision in `whisper-tiny-en_quality_cpu.json` and fetched at test time:

| File | Description |
| --- | --- |
| `whisper-tiny-en/real_weights.irpa` | Externalized model parameters |
| `whisper-tiny-en/inference_input.0a.bin` | Log-mel features (`1x80x3000xf32`) |
| `whisper-tiny-en/inference_input.0b.bin` | Decoder input ids (`1x33xi64`) |
| `whisper-tiny-en/inference_output.0.bin` | Expected output logits (`1x33x51864xf32`) |
